...
export const DESCRIPTION_CATEGORY_HINTS: { keywords: string[]; nameHints: string[] }[] = [
    ...
    },
    {
        ...
        nameHints: ['ropa', 'vestuario', 'calzado', 'personal', 'moda', 'prendas'],
    },
    {
        keywords: [
            'cupcake',
        ...
        nameHints: ['comida', 'alimentacion', 'antojo', 'postre', 'restaurante', 'dulce', 'panaderia'],
    },
    {
        keywords: [
            'perfume',
        ...
        nameHints: ['cuidado', 'personal', 'salud', 'belleza', 'aseo', 'farmacia', 'drogueria'],
    },
];
...
export const CATEGORY_KEYWORD_RULES: CategoryKeywordRule[] = [
    ...
    // --- Servicios públicos: Gas (Colombia) ---
    {
        ...
        confidence: 0.88,
        reason: 'Servicio de gas detectado',
    },

    // --- Servicios públicos: Electricidad / Luz (Colombia) ---
    {
        type: 'expense',
        keywordGroups: [
            [
        ...
        subcategoryName: 'Servicios',
        confidence: 0.88,
        reason: 'Servicio de energía/electricidad detectado',
    },

    // --- Servicios públicos: Agua / Acueducto (Colombia) ---
    {
        type: 'expense',
        keywordGroups: [
            [
        ...
        subcategoryName: 'Servicios',
        confidence: 0.88,
        reason: 'Servicio de agua/acueducto detectado',
    },

    // --- Servicios públicos: Internet / Telecomunicaciones (Colombia) ---
    {
        type: 'expense',
        keywordGroups: [
            [
        ...
        subcategoryName: 'Servicios',
        confidence: 0.88,
        reason: 'Servicio de telecomunicaciones/internet detectado',
    },
    ...
    },
    {
        ...
        parentName: 'Gastos personales',
        subcategoryName: 'Ropa',
        confidence: 0.88,
        reason: 'Ropa, calzado o prendas de vestir detectadas',
    },
    {
        type: 'expense',
        keywordGroups: [
        ...
        parentName: 'Comida',
        subcategoryName: 'Antojos',
        confidence: 0.88,
        reason: 'Postre, pastelería o antojo detectado',
    },
    {
        type: 'expense',
        keywordGroups: [
        ...
        parentName: 'Gastos personales',
        subcategoryName: 'Cuidado personal',
        confidence: 0.88,
        reason: 'Cuidado personal, perfumería o belleza detectado',
    },
];
